...
function default_1(injectedStore) {
    ...
    insert: (email, password) => __awaiter(this, void 0, void 0, function* () {
        ...
        return bcrypt_1.default.compare(password, data.encrypted_password)
            ...
            if (areEqual === true) {
                console.log(chalk_1.default.redBright('Password and Encripted password are equeal!'));
    ...
    //user auth
    upsert: (respon, data) => __awaiter(this, void 0, void 0, function* () {
